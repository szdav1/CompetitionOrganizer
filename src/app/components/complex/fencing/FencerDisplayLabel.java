...
public final class FencerDisplayLabel extends AbstractFencerDisplayLabel {
    public FencerDisplayLabel(String name, String place, XFrame frame, Appearance appearance) {
        super(name, place, frame, appearance);
    }
